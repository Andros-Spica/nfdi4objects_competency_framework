...
The following Research Data Management Competency Framework is based on previous frameworks (see reference sources), however it is presented to address specifically the expert domain of the NFDI4Objects consortium, namely the study and conservation of material heritage.
